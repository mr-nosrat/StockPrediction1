...
public class StockDataSetIterator implements DataSetIterator {
     ...
     */
    private List<StockData> train, test1;
    /**
    ...
    public StockDataSetIterator(String filename, String symbol, int miniBatchSize, int exampleLength, double splitRatio, PriceCategory category) {
        ...
        test1 = stockDataList.subList(split, stockDataList.size());
        test = generateTestDataSet(test1);
        initializeOffsets();
    }
    ...
    public List<StockData> getTest1() {
        return test1;
    }
    ...
    private List<Pair<INDArray, INDArray>> generateTestDataSet(List<StockData> stockDataList) {
        ...
        for (int i = 0; i < stockDataList.size() - exampleLength; i++) {
            ...
            for (int j = i; j < i + exampleLength; j++) {
                ...
                if (i == stockDataList.size() - exampleLength - 1)
                    System.out.println((j - i) + stock.getDate() + " - " + String.valueOf(stock.getClose()));
            }
            StockData stock = stockDataList.get(i + exampleLength);
            System.out.println(stock.getDate() + " - " + String.valueOf(stock.getClose()));
